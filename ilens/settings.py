...
# WSGI_APPLICATION = 'ilens.wsgi.application'

ASGI_APPLICATION = "ilens.asgi.application"
# Database
...
REST_FRAMEWORK = {
    "DEFAULT_AUTHENTICATION_CLASSES": ("accounts.backends.CustomJWTAuthentication",),
